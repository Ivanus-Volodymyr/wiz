  ...
  return (
    <div className="px-[7%] pt-12 pb-10">
      <div className="flex justify-between flex-col lg:flex-row gap-4">
        <h5 className="font-montserrat font-medium text-xl">Address</h5>
        <Button color="primary" className="rounded-[3px]" outline>
          <p>Edit</p>
          <PencilIcon className="fill-main-primary" />
        </Button>
      </div>
      <div className="border-b-[1px] border-border-default">
        <div className="py-9 px-4 lg:w-[60%] space-y-[76px]">
          <p className="font-bold text-lg text-main-primary">HOME</p>
          <div className="flex justify-between flex-col lg:flex-row gap-4">
