...
import DropdownMenu, { type DropdownMenuItemType } from '../../../../../components/common/DropdownMenu';
import type { MilestoneAmountType } from '../../../../../types/contracts';
...
export default function MilestoneReviewSign() {
        ...
        <div ref={printContentRef}>
          ...
          <div className="px-3 sm:px-12 py-14 border-b border-[#CDD6EC]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 mb-12">
              ...
              <div></div>
              <div>
                <p className="text-base text-[#3E4B6D] mb-2">No. of milestones</p>
                <p className="text-base font-bold text-[#0D1835] mb-0">13</p>
              </div>
            </div>
            <div>
              <p className="text-base text-[#3E4B6D] mb-2">Milestone tasks</p>
              <div className="mb-16">
                {contracts?.[0]?.milestones?.map((rs: MilestoneAmountType, key: number) => (
                  <div className="grid grid-cols-1 lg:grid-cols-3 border-b border-[#CDD6EC] p-[10px]" key={key}>
                    <div className="flex items-center">
                      <div className="w-[30px] h-[30px] flex items-center justify-center bg-[#E0ECF8] text-base text-[#0D1835]">
                        {key + 1}
                      </div>
                      <p className="mb-0 ml-4 text-base text-[#0D1835] font-bold">{rs?.name}</p>
                    </div>
                    <div></div>
                    <div className="flex items-center">
                      <p className="text-base text-[#0D1835] font-bold ml-11 lg:ml-0">
              ...
              <div className="mb-3 lg:mb-0">
                <p className="text-base text-[#3E4B6D] mb-2">Budget</p>
                <p className="text-base font-bold text-[#0D1835] mb-0">
                  ${contracts?.[0]?.contract_amount.toLocaleString()}
                </p>
              </div>
            </div>
          </div>
