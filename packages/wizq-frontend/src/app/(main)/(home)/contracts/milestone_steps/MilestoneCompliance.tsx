...
export default function MilestoneCompliance({ step, setStep, refetch }: ContractsStepProps) {
        ...
        <form id={step} onSubmit={handleSubmit(handlerSubmit)}>
          ...
          <div className="flex gap-2 items-center mb-16">
            ...
            <p className="text-label-disable text-sm">
              You’ll make payments to the service provider after each milestone until the contract has been concluded.
            </p>
          </div>
