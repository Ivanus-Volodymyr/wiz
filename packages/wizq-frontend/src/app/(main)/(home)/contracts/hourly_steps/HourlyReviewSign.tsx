...
export default function HourlyReviewSign() {
        ...
        <div ref={printContentRef}>
          ...
          <div className="px-3 sm:px-12 py-14 border-b border-[#CDD6EC]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 mb-12">
              ...
              <div></div>
              <div>
                <p className="text-base text-[#3E4B6D] mb-2">Hourly rate</p>
                <p className="text-base font-bold text-[#0D1835] mb-0">
                  ${contracts?.[0]?.hourly_rate?.toLocaleString()}/hr
                </p>
              </div>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-3 mb-12">
              <div className="mb-3 lg:mb-0">
                <p className="text-base text-[#3E4B6D] mb-2">Weekly limit</p>
                <p className="text-base font-bold text-[#0D1835] mb-0">
                  {contracts?.[0]?.weekly_limit?.toLocaleString()} hrs
                </p>
              </div>
            </div>
          </div>
