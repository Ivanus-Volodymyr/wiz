...
import { useDeleteContractsFileByIdMutation, useSetContractsMutation } from '../../../../../store/projects';
...
export default function HourlyCompliance({ step, setStep, refetch }: ContractsStepProps) {
